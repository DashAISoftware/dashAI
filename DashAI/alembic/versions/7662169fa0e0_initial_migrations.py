...
def upgrade() -> None:
    ...
    op.create_table('agentic_conversations',
    ...
    op.create_table('agentic_parameters',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('configuration_name', sa.String(), nullable=False),
    sa.Column('configuration_description', sa.String(), nullable=True),
    sa.Column('family_model_name', sa.String(), nullable=False),
    ...
    op.create_table('agentic_process',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('conversation_id', sa.Integer(), nullable=False),
    sa.Column('start_time', sa.DateTime(), nullable=True),
    sa.Column('end_time', sa.DateTime(), nullable=True),
    sa.Column('status', sa.Enum('NOT_STARTED', 'DELIVERED', 'STARTED', 'FINISHED', 'ERROR', name='runstatus'), nullable=False),
    sa.ForeignKeyConstraint(['conversation_id'], ['agentic_conversations.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('agentic_conversation_messages',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('text', sa.String(), nullable=False),
    sa.Column('process_id', sa.Integer(), nullable=False),
    sa.Column('is_input', sa.Boolean(), nullable=False),
    sa.ForeignKeyConstraint(['process_id'], ['agentic_process.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('agentic_conversation_messages')
    op.drop_table('agentic_process')
    ...
    op.drop_table('agentic_parameters')
    op.drop_table('agentic_conversations')
    # ### end Alembic commands ###
