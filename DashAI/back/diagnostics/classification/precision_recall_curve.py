"""Precision recall curve diagnostic."""
...
from DashAI.back.diagnostics.classification.roc_curve import probability_matrix


class PrecisionRecallCurve(BaseDiagnostic):
