...
class SentenceTransformerEmbedding(DenseEmbedding):
    ...
    DESCRIPTION: str = MultilingualString(
        en="Dense embeddings using Sentence Transformer models with mean pooling and L2 normalization.",
        es="Embeddings densos usando modelos Sentence Transformer con mean pooling y normalización L2.",
    )
