...
import { Input } from "../../../../components/configurableObject/Inputs/InputStyles";
...
/**
 * RAG-specific version of FormSchemaFieldWithParent that properly renders
 * the sub-model configuration modal when the Settings icon is clicked.
 * 
 * This component handles nested model parameters (e.g., retriever with encoding_model).
 */
function RAGFormSchemaFieldWithParent({
  name,
  label,
  field,
  description,
  ...
  const handleSubModelSave = (values) => {
    if (formValues && formValues[name]) {
      setFormValues((prevFormValues) => {
        ...
        // Update the sub-model parameters
        updatedFormValues[name].properties.params.comp.params = {
          ...updatedFormValues[name].properties.params.comp.params,
          ...values,
        };
    ...
    <>
      ...
      >
        ...
        <DialogActions>
          ...
          <Button
            onClick={() => {
              // Get the current form values from Formik and save them
...
RAGFormSchemaFieldWithParent.propTypes = {
...
export default RAGFormSchemaFieldWithParent;
