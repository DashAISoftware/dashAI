...
function Home() {
  ...
  const modules = [
    ...
    },
    {
      ...
      accent: theme.palette.accent.green,
      accentDim: theme.palette.accent.greenDim,
      accentBorder: theme.palette.accent.greenBorder,
      accentGlow: theme.palette.accent.greenGlow,
      tag: t("home:tag.advanced"),
      chips: [
        t("home:chip.exploreConvertData"),
        t("home:chip.modelTraining"),
        t("home:chip.modelComparison"),
        t("home:chip.predictions"),
      ],
      tourAttr: "pipelines-button",
    },
    {
