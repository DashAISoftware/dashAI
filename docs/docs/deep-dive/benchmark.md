...
| No production paywall           |               No                |        Yes         |         Yes          |          **Yes**          |
| **Extensibility**               |                                 |                    |                      |                           |
...
| Autogenerated UI                |             Partial             |         No         |          No          |          **Yes**          |
...
| Text classification models      |             Partial             |      Partial       |       33 (BoW)       |          **15**           |
...
**Legend:** Yes = full native support, Partial = partial or requires additional extensions, No = not supported, LoC = lines of code.

:::note Autogenerated UI
