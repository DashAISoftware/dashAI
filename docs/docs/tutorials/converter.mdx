...
![Navigate to dataset section](/img/tutorials/converter/step1.gif)

Navigate to the dataset section in DashAI to access the dataset you want to convert.

### 2. Open the Converter Modal

![Open converter modal](/img/tutorials/converter/step2.gif)
...
![Select converter](/img/tutorials/converter/step3.gif)
...
![Configure converter](/img/tutorials/converter/step4.gif)
...
![Set scope of converter](/img/tutorials/converter/step5.gif)
...
![Set target column](/img/tutorials/converter/step6.gif)
...
![Start conversion](/img/tutorials/converter/step7.gif)
