...
![Select dataset](/img/tutorials/train_model/step4.gif)
...
![Configure input output](/img/tutorials/train_model/step5.gif)
...
![Select model](/img/tutorials/train_model/step6.gif)
...
![Select model](/img/tutorials/train_model/step7.gif)
...
![Select model](/img/tutorials/train_model/step8.gif)
