...
Un **componente** es el bloque de construcción fundamental de DashAI. Toda pieza de funcionalidad conectable — modelos, tareas, métricas, exploradores, explicadores, conversores, cargadores de datos, optimizadores y trabajos — es un componente.
