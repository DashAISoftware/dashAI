...
| `ModelSession`                      | Configuración del experimento — conjunto de datos, nombre de la tarea, columnas de entrada/salida, proporciones de división train/validación/test y métricas seleccionadas por división.                                                      |
...
| `Prediction`                        | Trabajo de predicción — vincula una ejecución entrenada a un Dataset de entrada, rastrea el estado y tiempos de ejecución, y almacena la ruta a los resultados de salida.                                                                    |
...
| `GenerativeProcess`                 | Una invocación individual de una GenerativeSession — rastrea el estado y tiempos de ejecución. Vinculado a registros ProcessData que contienen las cargas útiles de entrada y salida.                                                        |
...
| `Notebook`                          | Sesión de trabajo con un conjunto de datos — una copia mutable de un Dataset fuente sobre la que se pueden aplicar Exploradores y Conversores. Los cambios pueden revertirse; el resultado puede guardarse como un nuevo Dataset para el entrenamiento de modelos. |
...
| `Converter`                         | Paso individual de conversor aplicado al conjunto de datos mutable de un Notebook — tipo de conversor, parámetros, estado de ejecución y tiempos. Múltiples registros forman una pipeline de transformación ordenada sobre el Notebook.      |
