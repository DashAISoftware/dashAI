...
| `Notebook`                          | Sesión de trabajo con un dataset — una copia mutable de un Dataset fuente sobre la que se pueden aplicar Exploradores y Conversores. Los cambios pueden revertirse; el resultado puede guardarse como un nuevo Dataset para el entrenamiento de modelos. |
...
| `Converter`                         | Paso individual de conversor aplicado al dataset mutable de un Notebook — tipo de conversor, parámetros, estado de ejecución y tiempos. Múltiples registros forman una pipeline de transformación ordenada sobre el Notebook.      |
