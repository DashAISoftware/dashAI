---
title: ¿Qué es un Workbench?
sidebar_label: ¿Qué es un Workbench?
sidebar_position: 1
---
...
## ¿Para quién es dashAI?

dashAI está diseñado para personas que necesitan utilizar ML sin programar, pero que no quieren una caja negra que oculte el proceso:

- **Estudiantes** de cursos no computacionales que necesitan ejecutar análisis y justificar resultados
- **Docentes** que desean incorporar el ML en sus cursos sin requerir conocimientos previos de programación
- **Investigadores aplicados** que necesitan el ML como herramienta metodológica sin depender de ingenieros de software
- **Autodidactas** que quieren entender el ML mediante la experimentación práctica

---

## Lo que dashAI no es

- No es una plataforma AutoML que elige todo por ti
- No es un entorno de notebook o código
- No es un sistema de despliegue en producción

dashAI es un entorno de aprendizaje y experimentación donde el proceso es tan importante como el resultado.
